...
CREATE TABLE `usuarios_comunidades` (
  ...
  CONSTRAINT `usuarios_comunidades_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `usuarios_comunidades_ibfk_2` FOREIGN KEY (`comunidad_id`) REFERENCES `comunidades` (`id`) ON DELETE CASCADE
